              ...
              <TableBody>
                {reviews.map((review) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <p className="text-[10px] text-slate-600 italic line-clamp-2 max-w-sm uppercase tracking-tight">
                        "{review.comment}"
                      </p>
                    </TableCell>
        ...
        <ShadDialogContent className="sm:max-w-[400px] rounded-none border-slate-200 font-mono">
          <ShadDialogHeader className="border-b border-slate-100 pb-4">
            <ShadDialogTitle className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-rose-600">
              <AlertTriangle className="h-4 w-4" /> Security_Protocol:
              Purge_Content
            </ShadDialogTitle>
          ...
          <div className="py-4">
            <p className="text-[10px] text-slate-600 uppercase tracking-widest leading-relaxed">
              WARNING: This action cannot be reversed. The feedback data will be
              permanently purged from the central database.
            </p>
          </div>
